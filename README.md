...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ub8oyt4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ub8oyt4.containers.anotherwebservice.com/
...
```
git clone git@github.com:IntellibridgeAIdev/container-ub8oyt4.git
cd container-ub8oyt4
```
...
```
docker attach container-ub8oyt4
```
